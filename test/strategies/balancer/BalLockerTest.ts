...
describe("Bal locker tests", function () {
  ...
  before(async function () {
    ...
    const controller = await DeployerUtilsLocal.deployContract(signer, 'ControllerMinimal', signer.address) as ControllerMinimal;

    locker = await DeployerUtilsLocal.deployContract(signer, 'BalLocker',
      controller.address,
      signer.address,
    ...
    const authorizer = await DeployerUtilsLocal.impersonate('0x8F42aDBbA1B16EaAE3BB5754915E0D06059aDd75');
